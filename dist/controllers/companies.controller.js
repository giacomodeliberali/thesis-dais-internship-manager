 ...
 */
let CompaniesController = class CompaniesController extends base_controller_1.BaseController {
    /**
     ...
     */
    constructor(companiesRepository, app) {
     ...
     */
    useGetByOwnerId() {
        this.router.get('/getByOwnerId/:ownerId', (req, res) => __awaiter(this, void 0, void 0, function* () {
