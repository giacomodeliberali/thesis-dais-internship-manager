...
%% Subtitle (Optional)
\subtitle{Piattaforma per la gestione dei tirocini universitari}
...
\crest{\includegraphics[width=0.2\textwidth]{University_Ca_Foscari}}
